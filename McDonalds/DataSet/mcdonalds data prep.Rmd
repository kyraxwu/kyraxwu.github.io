...
summary(as_factor(world_countries$income_grp))
...
world_countries <- ne_countries(scale = "medium", returnclass = "sf")
  ...
  # Join outlets data with the world map data
outlets <- world_countries %>%
    left_join(outlets, by = c("adm0_a3" = "country_code")) %>% 
    select("name","outlets_per_mil", "num_outlets", "First Opening", "pop_est", "gdp_md_est", "economy", "income_grp", "geometry", "centroid_lat","centroid_long") %>% na.omit()# %>% distinct()
