...
The chart uses color-coding to display correlations, with red indicating strong negative correlations and yellow representing strong positive correlations. You can hover over squares to view exact correlation coefficients and customize the chart by selecting specific variables of interest.
...
<iframe height="500" width="100%" frameborder="no" src="https://kyrawu.shinyapps.io/McDNutrition/">
